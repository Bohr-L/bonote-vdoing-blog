...
-e KUBOARD_ENDPOINT="http://kuboard.dev.bonote.com" \
-e KUBOARD_AGENT_SERVER_TCP_PORT="10081" \
-e KUBOARD_ROOT_USER="superadmin" \
--link openldap:ldap \
-e LDAP_HOST="ldap:389" \
-e LDAP_SKIP_SSL_VERIFY="true" \
-e LDAP_BIND_DN="cn=admin,dc=bonote,dc=com" \
-e LDAP_BIND_PASSWORD="******" \
-e LDAP_BASE_DN="dc= bonote,dc=com" \
...
-e LDAP_GROUP_SEARCH_BASE_DN="dc=bonote,dc=com" \
